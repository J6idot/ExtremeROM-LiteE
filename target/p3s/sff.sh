...
SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_SPEN_GARAGE_SPEC=type=inbox, bundled=false, unbundled_spec=remote
SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_SPEN_VERSION=75
